...
class HeadsetButtonControl {
    ...
    fun registerHeadsetButton(context: Context, headsetButtonControlListener: HeadsetButtonControlListener) {
        ...
        androidx.localbroadcastmanager.content.LocalBroadcastManager.getInstance(context).registerReceiver(broadcastButtonReceiver!!, filter)
    }
    ...
    fun unregisterHeadsetButton(context: Context) {
        ...
        if (null != broadcastButtonReceiver) androidx.localbroadcastmanager.content.LocalBroadcastManager.getInstance(context).unregisterReceiver(broadcastButtonReceiver!!)
    }
